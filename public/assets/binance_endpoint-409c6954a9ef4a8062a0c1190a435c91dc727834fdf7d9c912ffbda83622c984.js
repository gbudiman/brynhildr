	...
	var append_dom = function() {
		...
		$.each(pairs, function(_junk, pair) {
			...
			s +=       '<div class="col-xs-2 colfig" />'
			  ...
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-open-bithumb">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-open-bithumb">--</span>'
			  +        '</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-open-coinone">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-open-coinone">--</span>'
			  +        '</div>'			  
			  +        '<div class="col-xs-2 colfig">H</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-high-bithumb">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-high-bithumb">--</span>'
			  +        '</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-high-coinone">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-high-coinone">--</span>'
			  +        '</div>'		
			  +        '<div class="col-xs-2 colfig">L</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-low-bithumb">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-low-bithumb">--</span>'
			  +        '</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-low-coinone">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-low-coinone">--</span>'
			  +        '</div>'		
			  +        '<div class="col-xs-2 colfig">C</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-close-bithumb">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-close-bithumb">--</span>'
			  +        '</div>'
			  +        '<div class="col-xs-3 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-nominal-' + pair + '-close-coinone">--</span>'
			  +        '</div><div class="col-xs-2 colfig">'
			  +          '<span class="local-ticker pull-right" id="local-pctg-' + pair + '-close-coinone">--</span>'
			  +        '</div>'					  
			  // +        '<span local-ticker" id="local-' + pair + '-open-coinone">--</div>'
			  // +        '<div class="col-xs-2 colfig">H</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-high-bithumb">--</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-high-coinone">--</div>'			  
			  // +        '<div class="col-xs-2 colfig">L</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-low-bithumb">--</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-low-coinone">--</div>'			  
			  // +        '<div class="col-xs-2 colfig">C</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-close-bithumb">--</div>'
			  // +        '<span local-ticker" id="local-' + pair + '-close-coinone">--</div>'			  
